# Contributing to Nanopub Registry

A big welcome and thank you for considering contributing to **Nanopub Registry**! It's people like you that
...
the PRs and new changes are pushed to the `main` branch before being released. When a new release is to be made, the
